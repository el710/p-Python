...
async def get_buying_list(message):
    for i in range(1, 5):
        # await message.answer(f"Name: product{i} | Desc: script {i} | Price: {i * 100} ")
        with open(f"product_{i}.jpg", "rb") as image:
            await message.answer_photo(image, f"Name: product{i} | Desc: script {i} | Price: {i * 100} ")
